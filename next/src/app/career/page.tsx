    ...
    return (
        <>
            ...
            <Hero textSize={'5xl'} title="Become a part of our big family to inspire  and get inspired by professional experts."
                ...
                <ActionButton label="Our benefits" variant="secondary" target="/career"/>
            </Hero>
            <OpenPositions/>
            <Gallery title="Pay us a visit & have some coffee!" subtitle="Our team" images={TEAM_GALLERY_IMAGES}/>
            <Benefits benefits={benefitsData}/>
            <CallToActionSection title="let’s talk" subtitle="Didn’t find a suitable position? Send us your CV"/>
            <Footer/>
        </>
    )
}
