    ...
    return (
        <>
            ...
            <Hero textSize={'5xl'} title="A strong team of professionals delivering successful software projects around the world"
                ...
                <ActionButton label="Our team" variant="secondary" target="/career"/>
            </Hero>
            <StatisticsSection/>
            <LeadershipSection/>
            <HistoryTimeline/>
            <GetInTouchSection>We create dreams for the future.<br/>We realize them successfully.</GetInTouchSection>
            <CallToActionSection/>
            <Footer/>
        </>
    )
