...
export function JobCard({ position }: JobCardProps) {
  return (
    <div className="flex flex-wrap gap-6 items-center p-6 w-full bg-white rounded-3xl border border-gray-200 border-solid max-md:px-5 max-md:max-w-full">
      ...
      <div className="flex flex-col grow shrink self-stretch my-auto text-base font-bold text-white whitespace-nowrap rounded-xl w-[137px]">
        <button
