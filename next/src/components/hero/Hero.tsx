...
export function Hero({textSize, title, subtitle, image, imageWidth, children}: HeroProps) {
    return (
        <main className="flex flex-col px-20 pb-24 w-full bg-neutral-800 max-md:px-5 max-md:max-w-full">
            <section className="z-10 self-center -mt-1.5 w-full max-w-[1150px] max-md:max-w-full">
                <div className="flex gap-5 max-md:flex-col justify-between">
                    <div className={`${styles.textSection} flex flex-col  max-md:ml-0 max-md:w-full`}>
                        <HeroText
                            textSize={textSize}
                            subtitle={subtitle}
                            title={title}
                    ...
                    <div className={`flex flex-col ml-5 w-[${imageWidth}] max-md:ml-0 max-md:w-full`}>
                        <Image
                            loading="lazy"
                            src={image}
