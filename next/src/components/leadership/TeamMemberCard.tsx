...
export const TeamMemberCard: React.FC<TeamMemberProps> = ({
  ...
  return (
    <div className="flex overflow-hidden flex-col grow justify-center w-full bg-white rounded-3xl border border-solid border-stone-300 min-h-[485px] max-md:mt-5">
      <div className="flex flex-col flex-1 w-full">
        <Image
          loading="lazy"
          src={image}
          alt={`${name} - ${role}`}
          className={`object-contain w-full aspect-[${imageAspect}]`}
        />
      </div>
