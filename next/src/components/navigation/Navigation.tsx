...
export function Navigation() {
    return (
        <header
            className="flex flex-wrap gap-5 justify-between px-16 py-10 w-full text-base tracking-widest text-white uppercase bg-neutral-800 max-md:px-5 max-md:max-w-full">
