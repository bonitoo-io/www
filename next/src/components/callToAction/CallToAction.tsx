            ...
            >
                <div className="flex gap-5 max-md:flex-col">
                    <article className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
                        <div
                            className="flex flex-col items-start self-stretch my-auto w-full font-bold text-white max-md:mt-10 max-md:max-w-full">
                            <h2 id="cta-title" className="font-normal text-lg tracking-widest uppercase">
                                {title}
                            </h2>
