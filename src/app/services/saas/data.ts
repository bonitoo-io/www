...
export const saasData = {
  title:
    "Bonitoo specializes in technological and IT-related services such as product management, product engineering, quality management, building cloud, infrastructure, network, etc.",
  subtitle: "our part",
  firstSection: {
    ...
    services: [
      {
        ...
        description:
          "We have a long experience in product management, planning, design, developing, operating and supporting MVPs for startups and small businesses ready to enter the market.",
      },
      {
  ...
  secondSection: {
    ...
    services: [
      ...
      },
      {
        ...
        description:
          "We are ready to analyze and take your projects over. We have restored projects with zero support from the previous development team just from the source code.",
      },
    ],
  },
};
