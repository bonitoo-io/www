...
export const CaseStudyCard: React.FC<CaseStudyCardProps> = ({
  ...
  return (
    ...
    >
      <div className="flex overflow-hidden flex-col grow justify-center w-full bg-neutral-800 rounded-3xl min-h-[626px] max-md:mt-6 focus:outline-none focus:ring-2 focus:ring-blue-500">
        <Image
          loading="lazy"
          src={image}
          alt={imageAlt}
