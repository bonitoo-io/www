...
export const RelatedPost: React.FC<RelatedPostProps> = ({
  ...
  return (
    <article className="flex overflow-hidden flex-col grow justify-center w-full bg-white rounded-3xl border border-solid border-stone-300 min-h-[431px] max-md:mt-6 max-md:max-w-full hover:shadow-lg transition-shadow">
      <div className="flex flex-col flex-1 w-full max-md:max-w-full">
        <img
          loading="lazy"
          src={imageUrl}
          alt=""
          className="object-cover w-full aspect-[2.54] max-md:max-w-full"
        />
      </div>
      <div className="flex flex-col p-8 w-full max-md:px-5 max-md:max-w-full">
        <div className="flex justify-between items-start w-full max-md:max-w-full">
          <div className="flex flex-col flex-1 shrink w-full basis-0 min-w-[240px] max-md:max-w-full">
            ...
            <h3 className="mt-1 text-3xl font-bold leading-8 text-neutral-800 max-md:max-w-full">
              {title}
            </h3>
          </div>
        </div>
